...
import { AlertTriangle, ArrowDownRight, ArrowUpRight, Landmark, BadgeAlert } from 'lucide-react';
          ...
          <div key={idx} className="finance-card bg-white border border-zinc-200 rounded-[2rem] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all">
            ...
            <div className="flex justify-between items-start mb-8">
              <div className="flex flex-col md:flex-row md:items-center gap-4">
                ...
                <div>
                  <h3 className="font-black text-zinc-950 text-xl tracking-tight leading-none mb-1">{note.corretora}</h3>
                  <p className="text-zinc-500 text-sm font-medium tracking-wide">Pregão B3: {note.data_pregao}</p>
                </div>
              </div>
              
              {note.eventos_pendentes && (
